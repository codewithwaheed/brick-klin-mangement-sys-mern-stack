...
export default class EditSale extends Component {
  ...
  componentWillMount() {
    Axios.get("http://localhost:5000/sale/" + this.props.match.params.id)
      .then(Response => {
        this.setState({
          ...
          v_debtor_name: Response.data.debtor_name,
  ...
  getPaymentMethod = e => {
    ...
    if (this.state.v_payment_method !== "credit") {
      this.setState({
        v_debtor_name: "none"
      });
    }
  ...
  AddValues = e => {
    ...
    Axios.post(
      "http://localhost:5000/sale/update/" + this.props.match.params.id,
      sale
            ...
            {this.state.v_payment_method === "credit" ? (
              <div className="col-md-2 ml-3 mb-3 mb-form">
                ...
                <input
                  ...
                  value={this.state.v_debtor_name}
                  defaultValue={this.state.v_debtor_name}
                  className="form-control"
                  id="validationDefault22"
                  required
                />
